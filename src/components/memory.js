...
class Memory extends React.Component {
  ...
  //       memory_id: this.props.activeMemory.id
  //     })
  //   }).then(res => res.json())
  //   .then(data => this.props.dispatch({type: 'add_photo', payload: [...this.props.activeMemory.photos, data]}))
  //   this.setState({location: '', description: '', add: !this.state.add})
  // }
  //
  ...
  render () {
    // let memory = this.props.activeUser.memories.filter(mem => mem.id === parseInt(this.props.match.params.id))
